                            ...
                            <form  action="<?=BASE_URL?>index.php?url=FilesController/updatefile" method="post">
                                ...
                                <select name="area" id="area"
                                    ...
                                    <div class="flex items-center me-4 pt-2">
                                        <input  id="purple-radio" type="radio" value="7" name="estado" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 focus:ring-purple-500 dark:focus:ring-purple-600"
                                     ...
                                     <div class="flex items-center me-4 pt-2 pb-5">
                                        <input  id="purple-radio" type="radio" value="8" name="estado" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 focus:ring-purple-500 dark:focus:ring-purple-600 "
                                        <?php if($archivo->getCod_estado() == 8) echo 'checked'; ?>>
                                        <label for="purple-radio" class="ms-2 text-sm font-medium text-gray-500">No Disponible</label>
