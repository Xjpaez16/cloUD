        ...
        <main class="text-center py-16 px-4">
            ...
            <div class="ease-out duration-300 grid grid-cols-1 sm:grid-cols-3 gap-5 mb-80 font-bold">
                <div class="flex flex-col items-center">
                    <p class="text-[20px] xl:text-[25px] lg:text-[20px] md:text-[20px] pb-2">Gestiona Materiales<br>Académicos</p>
                    <a href="#">
                        <img src="<?= BASE_URL ?>public/img/materials.png" class="w-40 h-48 sm:w-40 sm:h-48 md:w-48 md:h-56 lg:w-60 lg:h-64 xl:w-71 xl:h-80 mb-2 transition-transform duration-300 hover:scale-95"
                            alt="Materiales">
                    </a>
                </div>
                <div class="flex flex-col items-center">
                    ...
                    <a href="#">
                        <img src="<?= BASE_URL ?>public/img/users.png" class="w-40 h-48 sm:w-40 sm:h-48 md:w-48 md:h-56 lg:w-60 lg:h-64 xl:w-71 xl:h-80 mb-2 transition-transform duration-300 hover:scale-95"
                            alt="Usuario">
                    </a>
                </div>
                <div class="flex flex-col items-center">
                    ...
                    <a href="#">
                        <img src="<?= BASE_URL ?>public/img/calendar.png" class="w-40 h-48 sm:w-40 sm:h-48 md:w-48 md:h-56 lg:w-60 lg:h-64 xl:w-71 xl:h-80 mb-2 transition-transform duration-300 hover:scale-95"
                            alt="Tutorías">
                    </a>
                </div>
            </div>
            ...
            <!-- Tarjetas de áreas -->
            <div class="font-bold font-sans grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 px-6 ">
                <div
                    ...
                    <p class="text-[20px] xl:text-[25px] lg:text-[20px] md:text-[20px]">Bases de Datos</p>
                </div>
                <div
                    class="bg-white/10 backdrop-blur-sm p-4 rounded-lg text-center hover:scale-105 transition-transform">
                    <a href="#">
