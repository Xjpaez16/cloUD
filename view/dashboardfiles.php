    ...
    <div class="relative z-10">
        ...
        <main class="text-center py-16 px-4">
            <div class="flex flex-col" >
                ...
                <br>
                <br>
                <div class="grid grid-cols-1 md:grid-cols-3  lg:grid-cols-3 xl:grid-cols-3 gap-8 xl:w-[800px] lg:w-[500px] md:w-[500px] mx-auto justify-center">
                    <a href="<?=BASE_URL?>index.php?url=RouteController/uploadfiles">
                        <div class="bg-[#5232a8] p-4 w-26 h-[250px] xl:w-60 xl:h-56   overflow-hidden rounded-lg border border-white hover:scale-90 transition-transform duration-300">
                            <img class="w-full h-full object-cover rounded-lg" src="<?= BASE_URL ?>public/img/updateFiles.png" alt="">
                        </div>
                    </a>
                    <a href="#">
                    <div class="bg-[#5232a8] p-4 w-26 h-[250px] xl:w-60 xl:h-56  overflow-hidden rounded-lg border border-white hover:scale-90 transition-transform duration-300">
