                    ...
                    <form action="<?= BASE_URL ?>index.php?url=StudentController/updateProfile" method="POST">
                        ...
                        <div class="mb-5">
                           <label for="Profesor" class="block font-semibold text-[#5D54A4]">Profesor : </label>
                            <select name="profesor" id="profesor" class="w-full px-4 py-2 mt-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#5D54A4]">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="area" id="area" class="w-full px-4 py-2 mt-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#5D54A4]">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="materia" id="materia" class="w-full px-4 py-2 mt-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#5D54A4]">
